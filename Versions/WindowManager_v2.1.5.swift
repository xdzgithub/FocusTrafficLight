...
//
//  =============================================================================
//  CHANGELOG (v2.1.5) — App Startup Open Panel / Save Panel Guard
//  =============================================================================
//
//  FIX: Added frontmostAppHasVisibleWindow() as a new guard in doFocusCheck().
//  This covers app startup scenarios (Keynote, Pixelmator Pro, etc.) where the
//  application displays an Open Panel / Save Panel / Dialog before its main
//  standard window appears.
//
//  PROBLEM:
//    When an app launches and shows an Open Panel, getCurrentFocusedWindow()
//    may transiently return nil (AX focus not yet set on the panel). The old
//    logic would fall through Guard 3 and trigger recovery, pulling focus to
//    another app with a standard window.
//
//  ROOT CAUSE:
//    Relying solely on getCurrentFocusedWindow() / isUsableFocusedWindow()
//    is insufficient during app startup transient states. The Open Panel is
//    a legitimate interactive window, but AX may not report it as the focused
//    window during the first few milliseconds.
//
//  FIX:
//    New Step 1 in doFocusCheck():
//      if frontmostAppHasVisibleWindow(frontmostApp) { return }
//
//    This checks whether the frontmost app has ANY visible AXWindow (regardless
//    of subrole — panel, dialog, sheet all count). If yes, recovery is blocked.
//
//  =============================================================================
//  PRIOR VERSION HISTORY
//  =============================================================================
//
//  v2.1.4 (2026-05-16) — Finder Quick Look CGWindow Hard Block
//  - Added isFinderQuickLookActive() with dual-layer interception
//
