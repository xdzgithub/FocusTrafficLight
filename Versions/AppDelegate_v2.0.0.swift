...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupStatusItem() {
        ...
        if let button = statusItem.button {
            button.image = NSImage(systemSymbolName: "chevron.left.forwardslash.chevron.right", accessibilityDescription: "FocusTrafficLight")
    ...
    private func showAccessibilityAlert() {
        ...
        alert.informativeText = "FocusTrafficLight needs accessibility access to manage window focus.\n\nPlease grant permission in System Settings > Privacy & Security > Accessibility."
