...
final class WindowManager {
    ...
    private func findTopmostValidWindow() -> (AXUIElement, NSRunningApplication)? {
        ...
        for windowInfo in windowList {
            ...
            // Step 2: Deep audit - check if valid standard window with traffic lights
    ...
    private func isValidStandardWindow(_ window: AXUIElement) -> Bool {
        ...
        guard AXUIElementCopyAttributeValue(window, kAXRoleAttribute as CFString, &role) == .success,
              ...
              roleStr == kAXWindowRole as String else {
            return false
        }
        ...
        guard AXUIElementCopyAttributeValue(window, kAXSubroleAttribute as CFString, &subrole) == .success,
              ...
              subroleStr == kAXStandardWindowSubrole as String else {
            return false
        }
